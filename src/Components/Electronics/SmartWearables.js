...
const SmartWearables = () => {
    ...
    const getWatches = async () => {
        try {
            const response = await axios.get("https://shopping-app-xkoy.onrender.com/shop/electronics/smartWearable/get", {
                headers: {
    ...
    const searchSmartWearables = async (event) => {
        ...
        if (key) {
            let result = await fetch(`https://shopping-app-xkoy.onrender.com/shop/electronics/smartWearable/searchSmartWearables/${key}`, {
                headers: {
                    accesstoken: localStorage.getItem("token"),
                }
            });
